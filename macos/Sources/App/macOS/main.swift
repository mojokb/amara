...
// Initialize Amara global state. We do this once right away because the
// CLI APIs require it and it lets us ensure it is done immediately for the
// rest of the app.
if ghostty_init(UInt(CommandLine.argc), CommandLine.unsafeArgv) != GHOSTTY_SUCCESS {
    Amara.logger.critical("ghostty_init failed")
    ...
    case .cli, .zig_run:
        ...
        stderrHandle.write(
            "Amara failed to initialize! If you're executing Amara from the command line\n" +
