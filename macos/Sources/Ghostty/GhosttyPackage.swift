...
extension Amara {
    ...
    enum SplitFocusDirection {
        ...
        /// Initialize from a Amara API enum.
...
extension Amara.SplitFocusDirection {
...
extension Notification.Name {
    ...
    static let AmaraConfigChangeKey = ghosttyConfigDidChange.rawValue
    ...
    static let AmaraColorChangeKey = ghosttyColorDidChange.rawValue

    /// Goto tab. Has tab index in the userinfo.
    static let ghosttyMoveTab = Notification.Name("com.mitchellh.ghostty.moveTab")
    static let AmaraMoveTabKey = ghosttyMoveTab.rawValue
