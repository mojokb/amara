...
extension Amara {
    ...
    /// because Amara input triggers are a superset of what can be represented by a macOS
    ...
    /// handling for Amara is handled at a lower level (usually). This function should generally only
    ...
    static func keyboardShortcut(for trigger: ghostty_input_trigger_s) -> KeyboardShortcut? {
        ...
        return KeyboardShortcut(
            key,
            modifiers: EventModifiers(nsFlags: Amara.eventModifierFlags(mods: trigger.mods)))
    }

    // MARK: Mods

    /// Returns the event modifier flags set for the Amara mods enum.
    ...
    static func ghosttyMods(_ flags: NSEvent.ModifierFlags) -> ghostty_input_mods_e {
        ...
        // Amara structure but that's okay -- we don't use that information.
    ...
    /// A map from the Amara key enum to the keyEquivalent string for shortcuts. Note that
...
// MARK: Amara.Input.BindingFlags

extension Amara.Input {
...
extension Amara.Input.Action: AppEnum {
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "Key Action")

    static var caseDisplayRepresentations: [Amara.Input.Action: DisplayRepresentation] = [
        .release: "Release",
        .press: "Press",
        .repeat: "Repeat"
    ]
...
extension Amara.Input.MouseState: AppEnum {
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "Mouse State")

    static var caseDisplayRepresentations: [Amara.Input.MouseState: DisplayRepresentation] = [
        .release: "Release",
        .press: "Press"
    ]
}

// MARK: Amara.Input.MouseButton
...
extension Amara.Input.MouseButton: AppEnum {
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "Mouse Button")

    static var caseDisplayRepresentations: [Amara.Input.MouseButton: DisplayRepresentation] = [
        .unknown: "Unknown",
        .left: "Left",
        .right: "Right",
        .middle: "Middle"
    ...
    static var allCases: [Amara.Input.MouseButton] = [
        .left,
        .right,
        .middle,
    ]
...
extension Amara.Input.Momentum: AppEnum {
    static var typeDisplayRepresentation = TypeDisplayRepresentation(name: "Scroll Momentum")

    static var caseDisplayRepresentations: [Amara.Input.Momentum: DisplayRepresentation] = [
        .none: "None",
        .began: "Began",
...
extension Amara.Input.Momentum {
...
extension Amara.Input {
    ...
    struct Mods: OptionSet {
        ...
        init(nsFlags: NSEvent.ModifierFlags) {
            self.init(cMods: Amara.ghosttyMods(nsFlags))
        }

        var nsFlags: NSEvent.ModifierFlags {
            Amara.eventModifierFlags(mods: cMods)
        }
    }
}

// MARK: Amara.Input.Key
...
extension Amara.Input.Key: AppEnum {
    ...
    static var allCases: [Amara.Input.Key] {
        return [
            // Letters (A-Z)
    ...
    static var caseDisplayRepresentations: [Amara.Input.Key: DisplayRepresentation] = [
        // Letters (A-Z)
