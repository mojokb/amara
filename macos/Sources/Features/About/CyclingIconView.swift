...
/// A view that cycles through Amara's official icon variants.
struct CyclingIconView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("Amara Application Icon")
        .accessibilityHint("Click to cycle through icon variants")
    }

    @ViewBuilder
    private func iconView(for icon: Amara.MacOSIcon?) -> some View {
