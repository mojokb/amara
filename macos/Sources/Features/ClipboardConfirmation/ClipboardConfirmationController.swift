...
class ClipboardConfirmationController: NSWindowController {
    ...
    init(surface: ghostty_surface_t, contents: String, request: Amara.ClipboardRequest, state: UnsafeMutableRawPointer?, delegate: ClipboardConfirmationViewDelegate) {
