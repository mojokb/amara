...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    // WARNING: An instance of this class is alive as long as Amara's icon is
    ...
    /// "Amara.app") so renaming the app in Finder still works.
    ...
    func setDockTile(_ dockTile: NSDockTile?) {
        // If no dock tile or no access to Amara defaults, we can't do anything.
        ...
        // is sent by the primary Amara app.
    ...
    private func resetIcon(dockTile: NSDockTile) {
        ...
        // Always reset to the system default icon (uses Ghostty.icns from the app bundle).
