...
/// The icon style for the Amara App.
enum AppIcon: Equatable, Codable {
    ...
    case customStyle(_ icon: ColorizedAmaraIcon)

#if !DOCK_TILE_PLUGIN
    init?(config: Amara.Config) {
        ...
        case .customStyle:
            ...
            self = .customStyle(ColorizedAmaraIcon(screenColors: screenColors, ghostColor: ghostColor, frame: config.macosIconFrame))
        }
    }
#endif
