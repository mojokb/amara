...
struct ColorizedAmaraIcon {
    ...
    let frame: Amara.MacOSIconFrame
...
extension ColorizedAmaraIcon: Codable {
    ...
    init(from decoder: any Decoder) throws {
        ...
        guard version == 0 || version == CodingKeys.currentVersion else {
            throw DecodingError.dataCorrupted(
                DecodingError.Context(
                    ...
                    debugDescription: "Unsupported ColorizedAmaraIcon version: \(version)"
                )
            )
        }
        ...
        let frame = try container.decode(Amara.MacOSIconFrame.self, forKey: .frame)
...
extension ColorizedAmaraIcon: Equatable {
