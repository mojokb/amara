...
class TransparentTitlebarTerminalWindow: TerminalWindow {
    ...
    private var lastSurfaceConfig: Amara.SurfaceView.DerivedConfig?
    ...
    override func syncAppearance(_ surfaceConfig: Amara.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceTahoe(_ surfaceConfig: Amara.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceVentura(_ surfaceConfig: Amara.SurfaceView.DerivedConfig) {
