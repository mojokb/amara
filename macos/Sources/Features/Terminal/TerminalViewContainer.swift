...
class TerminalViewContainer: NSView {
    ...
    func ghosttyConfigDidChange(_ config: Amara.Config, preferredBackgroundColor: NSColor?) {
...
extension TerminalViewContainer {
    ...
    struct DerivedConfig: Equatable {
        ...
        init?(config: Amara.Config, preferredBackgroundColor: NSColor?, cornerRadius: CGFloat?) {
