...
protocol TerminalRestorable: Codable {
    ...
    var baseConfig: Amara.SurfaceConfiguration? { get }
}
...
extension TerminalRestorable {
    ...
    var baseConfig: Amara.SurfaceConfiguration? { nil }
...
class TerminalWindowRestoration: NSObject, NSWindowRestoration {
    static func restoreWindow(
        ...
        if let focusedStr = state.focusedSurface {
            var foundView: Amara.SurfaceView?
    ...
    private static func restoreFocus(to: Amara.SurfaceView, inWindow: NSWindow, attempts: Int = 0) {
