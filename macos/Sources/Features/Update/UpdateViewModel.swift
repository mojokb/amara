...
enum UpdateState: Equatable {
    ...
    struct UpdateAvailable {
        ...
        var releaseNotes: ReleaseNotes? {
            let currentCommit = Bundle.main.infoDictionary?["AmaraCommit"] as? String
    ...
    struct Installing {
        /// True if this state is triggered by ``Amara/UpdateDriver/updater(_:willInstallUpdateOnQuit:immediateInstallationBlock:)``
