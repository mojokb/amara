...
> **Note:** amara is a fork of [Ghostty](https://github.com/ghostty-org/ghostty)
> by Mitchell Hashimoto, distributed under the MIT License.
> The development guidelines below are adapted from the original Ghostty project.

# Contributing to Ghostty (upstream reference)
